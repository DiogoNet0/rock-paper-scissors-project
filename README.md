...
This is my first **HTML/CSS/JS** project. **Live version** of the game is [here](https://diogonet0.github.io/rock-paper-scissors-project/).
...
![Game in the browser console](./images/rps_ss.jpg)
...
- For a more playful experience, **theme was changed** to _'Japanese Thematic'_ and **name was changed** to _'Ninja Oni Samurai'_.
- The game has a **responsive layout** with one breakpoint.
- The game is **fully playable** in the browser window.
- I really tried to keep **readable and understandable code**, **short functions**, **descriptive names** and **japanese mood** of the game.✨
